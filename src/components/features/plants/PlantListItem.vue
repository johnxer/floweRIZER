<template>
    <li
        ref="plantRef"
        :class="{ 'grid grid-cols-[auto_1fr] gap-2': uiStore.isMultiSelectEnabled }"
    >
        <div
        ...
        >
            ...
            >
                <div class="pl-[calc(var(--spacing)*8+30px)] md:pl-[calc(var(--spacing)*12+30px)] pr-2 rounded-xl transition-all duration-600 text-gray-400 dark:text-gray-500">
                    <div class="">
                        <div>
                            <p>
                                {{ shortenDesc }}
