<template>
    <div class="md:fixed md:top-0 md:w-full md:flex md:justify-center ">
        <div class="md:container md:absolute md:top-0 ">
            <div
                class="fixed md:absolute w-full left-0 md:left-auto md:right-0 md:w-[200px] md:top-[60px] bottom-0 md:bottom-auto bg-white px-4 py-1 md:p-6 transition-all duration-600 ease-in-out shadow-menu dark:bg-gray-900 z-10 md:rounded-xl md:flex md:justify-center"
